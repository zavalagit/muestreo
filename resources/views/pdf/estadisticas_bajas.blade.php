...
<body>
   ...
   <div class="tabla">
      <table class="">
         <caption class="amber"><h3><b>REPORTE BAJAS ARMAS DE FUEGO</b></h3></caption>
         ...
         <tbody>
          @foreach($bajas as $key => $baja)
              <tr class="grey lighten-2">
                  <td width=""><b>{{$baja->cadena->nuc}}</b></td>                  
                  <td width=""><b>{{$baja>fecha}}</b></td>
                   <td width="">
                      @foreach($baja->cadena->indicios as $key => $indicio)  
