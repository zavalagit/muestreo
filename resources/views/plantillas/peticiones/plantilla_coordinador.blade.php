...
<body class="brown lighten-5">
   ...
   <ul id="slide-out" class="side-nav fixed barra-lateral">
      ...
      <div class="barra-titulos" >
            ...
            <h6 class="datos-usuario center-align white-text"><b>COORDINADOR DE SERVICIOS PERICIALES</b></h6>
    ...
    <li>
        <a style="font-size:14px !important;" href="/peticion-estadistica-elegir" >
            <i style="color:#152f4a;" class="fas fa-sun"></i> INICIO
        </a>
    </li>
            ...
            <div class="collapsible-body sub-lista brown darken-4">
                <ul class="brown lighten-4" style="border-radius: 20px 0 25px 5px;">
                    @foreach ($unidades as $unidad)
                        <li>
                            <a href="/peticion-estadistica/unidad/{{$unidad->id}}" class="blue-grey-text text-darken-2">
                                {{$unidad->nombre}}
                            </a>
                        </li>
                    @endforeach
            ...
            <div class="collapsible-body sub-lista brown darken-4">
                <ul class="brown lighten-4" style="border-radius: 20px 0 25px 5px;">
                    @foreach ($fiscalias as $fiscalia)
                        @if ($fiscalia->id != 4)
                            <li>
                                <a href="/peticion-estadistica/fiscalia/{{$fiscalia->id}}" class="blue-grey-text text-darken-2">
                                    {{$fiscalia->nombre}}
                                </a>
                            </li>
                        @endif
    ...
    --}}  
      ...
      <li class="li-salir"><a style="font-size:14px !important;" href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();" class="brown-text a-menu"><i style="color:#152f4a;" class="fas fa-sign-out-alt i-menu" aria-hidden="true"></i>SALIR</a></li>
