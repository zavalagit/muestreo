...
<body class="brown lighten-5">
   ...
   <ul id="slide-out" class="side-nav fixed barra-lateral">
      ...
      <div class="barra-titulos" >
        <h6 class="datos-usuario center-align white-text"><b>{{Auth::user()->name}}</b></h6>
        <h6 class="datos-usuario center-align white-text"><b>EL BODEGAS</b></h6>
      </div>

      <!--Peticiones del día-->
      <li class="li-cadenas li-menu"><a href="/ubicacion-administrar" class="brown-text a-menu"><i class="fas fa-cog"></i>ADMIN</a></li>
      <li class="li-cadenas li-menu"><a href="/ubicacion-consultar" class="brown-text a-menu"><i class="fas fa-cog"></i>CADENAS</a></li>
      <!--
      <li class="li-cadenas li-menu"><a href="/peticion-diaria" class="brown-text a-menu"><i style="color:#394049;" class="fas fa-sun"></i>P. DEL DÍA</a></li>
      <li class="li-cadenas li-menu"><a href="/peticion-estadistica-director" class="brown-text a-menu"><i class="fas fa-chart-bar"></i>ESTADIST</a></li>
      -->
      <!--Consultar (Cadena)-->
