...
@section('titulo','CLONAR-CADENA')
@section('seccion', 'CLONAR CADENA DE CUSTODIA')
...
<div class="row">
  <form class="col s12" id="form-clonar">
  ...
  ACTUALIZAR IDENTIFICADORES">
    ...
    <div class="row" id="botones">
      <div class="fixed-action-btn">
        <button class="btn waves-effect waves-light" type="submit" id="btn-clonar" data-id="{{$cadena->id}}" name="action">
          CLONAR
        </button>
      </div>
    </div>
...
<script src="{{asset('js/cadenas/cadena_clonar.js')}}"></script>
<script type="text/javascript" src="{{asset('js/cadenas/1_identidad.js')}}"></script>
<script type="text/javascript" src="{{asset('js/cadenas/2_documentacion.js')}}"></script>
<script type="text/javascript" src="{{asset('js/cadenas/3_recoleccion.js')}}"></script>
<script type="text/javascript" src="{{asset('js/cadenas/5_servidores_publicos.js')}}"></script>
<script type="text/javascript" src="{{asset('js/cadenas/6_traslado.js')}}"></script>
