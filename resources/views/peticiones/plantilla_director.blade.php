...
<body class="brown lighten-5">
   ...
   <ul id="slide-out" class="side-nav fixed" style="background-color:#c6c6c6;">
      ...
      <div class="" style="background-color:#152f4a;" >
        <h6 class="datos-usuario center-align white-text"><b>VISTA DIRECTOR</b></h6>
        
      </div>
      <!--Nombre Usuario (Perito)-->

           <!--Registrar (Cadena)-->
           <li><a href="/registrar-cadena" class="brown-text a-menu"><i class="fas fa-folder-open"></i>PETICIONES</a></li>
           <!--Consultar (Cadena)-->
           <li class="li-cadenas li-menu"><a href="/consultar-cadena" class="brown-text a-menu"><i style="color:orange;" class="fas fa-sun"></i>P. DEL DÍA</a></li>
      <!--Mis Prestamos-->
...
--}}
   ...
   <header>
     <div class="row">
       ...
       <div class="col s12 nav-titulo center-align" style="background-color: #152f4a;">
         <span class=""><b>@yield('seccion')</b></span>
       </div>
     </div>
   </header>
