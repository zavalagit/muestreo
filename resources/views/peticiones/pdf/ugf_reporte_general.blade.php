         ...
         @foreach ($especialidades->sortBy('nombre') as $especialidad)
          ...
          @endforeach
            ...
            <tr>
              ...
              <td>Colectivos</td>
              @foreach ($fiscalias->sortBy('nombre') as $fiscalia)
                <td> {{ number_format( $colectivos->where('fiscalia_id',$fiscalia->id)->count() ) }} </td>
              @endforeach
              <td> {{ number_format( $colectivos->count() ) }} </td>
            </tr>
            ...
            <tr>
               ...
               @endforeach
               <td>{{number_format( $peticiones->whereIn('documento_emitido',['dictamen','certificado','informe'])->count() )}}</td>
            </tr>
