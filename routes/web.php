...
#muestreo
Route::resource('muestreos', 'MuestreoController');
#extraccion
Route::get('extracciones/create/{formAccion}','ExtraccionController@create')->name('extracciones.create');
Route::post('extracciones','ExtraccionController@store')->name('extracciones.store');
#pcrtr
Route::resource('pcrtrs', 'PCRTRController');
#pcr
